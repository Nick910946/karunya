        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 FormSection wow rightAnimate">
                    <img src="images/info-security-img-5.jpeg" class="w-100 shadow">
                </div>
                <div class="rightimages wow rightAnimate">
                    <!-- <img src="images/ts.png"> -->
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 ServiceProvideImageContent wow rightAnimate">
                    ...
                    <ul class="ulImage">
                        ...
                        <li>TELECOM EQUIPMENT AUDIT LAB </li>
                      
                        <li>MOBILE-BESPOKE SOFTWARE DEVELOPMENT </li>
                        <li>HOMELAND SECURITY-BESPOKE SOFTWARE DEVELOPMENT</li>
